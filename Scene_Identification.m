...
imds = imageDatastore('E:\Image processing\RICE with SB mask Files\code\Dataset\Masked V2',...
...
[training_set, test_set] = imds.splitEachLabel(20,5,'randomize',true);

%% Create Visual Vocabulary 
tic
bag = bagOfFeatures(training_set,...
    'VocabularySize',250,'PointSelection','Detector');
leafdata = double(encode(bag, training_set));
toc
...
SceneImageData = array2table(leafdata);
